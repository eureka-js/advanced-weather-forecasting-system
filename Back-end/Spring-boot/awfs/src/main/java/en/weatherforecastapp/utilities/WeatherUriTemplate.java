...
public class WeatherUriTemplate {
    ...
    public static final String HOURLY_WEATHER_INF
        = "https://api.open-meteo.com/v1/forecast?latitude=%s&longitude=%s&hourly=temperature_2m,relative_humidity_2m,apparent_temperature,weather_code,pressure_msl,visibility,wind_speed_10m,uv_index&forecast_days=1&timeformat=unixtime";
